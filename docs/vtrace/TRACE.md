...
| NEED-006 | RUNE-REQ-086 | Semantic registry CLI checks | `rune check-registry --fixture <path>` and approved profile/adapter catalog cross-checks | `cargo test -p rune-cli --test registry_cli --quiet` and workspace validation | Wave 42 Pulse 02 registry CLI evidence |
| NEED-006 | RUNE-REQ-087 | Semantic registry source-ref checks | `check_registry_collection_refs` and retained descriptor collection fixtures | Registry CLI source-ref mismatch test and workspace validation | Wave 42 Pulse 03 source-ref evidence |
| NEED-006 | RUNE-REQ-088 | Semantic registry inspection reports | `rune inspect-registry --fixture <path>` and retained inspection fixture | Registry CLI inspection tests and workspace validation | Wave 42 Pulse 04 inspection evidence |
| NEED-006 / NEED-010 | RUNE-REQ-089 | Final communications readiness | Communications strategy, registry how-to/runbook/example/trace, release readiness, corpus rules | Docs review and workspace validation | Wave 49 communications closeout |
...
| SPEC-RUNE-009 | RUNE-REQ-077 / RUNE-REQ-078 / RUNE-REQ-079 / RUNE-REQ-080 / RUNE-REQ-081 / RUNE-REQ-082 / RUNE-REQ-083 / RUNE-REQ-084 / RUNE-REQ-085 / RUNE-REQ-086 / RUNE-REQ-087 / RUNE-REQ-088 / RUNE-REQ-089 | Mission 2.0 managed native semantic runtime | DCR-RUNE-002 upgrades the mission and `docs/architecture/mission-2-planning-index.md` closes planning for semantic registry, state graph, evidence runtime, agent protocol, compatibility negotiation, capability policy, and optional runtime host lanes; DCR-RUNE-003 implements retained semantic registry document, read-only CLI validation, catalog checks, retained collection source-ref checks, and inspection reports; Wave 49 closes communications and readiness docs for v1 plus Wave 42. |
