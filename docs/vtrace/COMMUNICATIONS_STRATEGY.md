...
| COMMS-RUNE-BOUNDARY-001 | RUNE-REQ-084 / DCR-RUNE-002 / DCR-RUNE-003 / DCR-RUNE-004 / DCR-RUNE-005 / DCR-RUNE-006 | reviewer / platform owner | What is still blocked after Wave 45? | README, release readiness, architecture docs, VTRACE review | every Mission 2.0 lane | RUNE maintainer | accepted |
...
| Mission 2.0 registry, state graph, evidence packet, and agent protocol docs distinguish retained evidence from runtime behavior. | yes | accepted | Registry, state graph, evidence packet, and agent protocol how-to/runbook docs plus release readiness repeat blocked runtime, mutation, Cargo traversal, source scraping, plugin discovery, live state, and policy boundaries. |
