...
Trace walkthroughs connect commands, retained artifacts, and engineering
decisions. They are written for reviewers who need to understand why an output is
evidence.

| Walkthrough | Decision supported |
|---|---|
